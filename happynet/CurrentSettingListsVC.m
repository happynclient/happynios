...
- (void)viewDidLoad {
  ...
  UIColor *bgColor = [UIColor colorWithRed:242 / 255.0
                                     green:245 / 255.0
                                      blue:250 / 255.0
                                     alpha:1.0];
...
- (void)initUI {
  ...
  shieldIconBg.backgroundColor = [UIColor colorWithRed:0.2
                                                 green:0.5
                                                  blue:1.0
                                                 alpha:1.0];
  ...
  if (@available(iOS 13.0, *)) {
    UIImage *plusImg = [UIImage
         systemImageNamed:@"plus"
        withConfiguration:
    ...
    [navAddBtn setTitleColor:[UIColor systemBlueColor]
                    forState:UIControlStateNormal];
...
- (void)addSetting:(UIButton *)button {
